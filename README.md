## Dremio TIBCO Data Virtualization ARP Connector
The TIBCO Data Virtualization connector allows Dremio to connect to and query data in a TIBCO Data Virtualization server.

## Building and Installation

1. In root directory with the pom.xml file run `mvn clean install`
2. Take the resulting .jar file in the target folder and put it in the $DREMIO_HOME/jars folder in Dremio
3. Take the TIBCO Data Virtualization JDBC driver  (csjdbc.jar) from the client drivers package at https://edelivery.tibco.com/storefront/eval/tibco-data-virtualization/prod11801.html (requires TIBCO login) and put it in the $DREMIO_HOME/jars/3rdparty folder
4. Restart Dremio
